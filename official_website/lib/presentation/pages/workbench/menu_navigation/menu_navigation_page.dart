...
import 'package:official_website/presentation/pages/workbench/route_manager.dart';

/// 菜单导航配置页面
/// 所见即所得的底部菜单配置器
class MenuNavigationPage extends StatefulWidget {
  const MenuNavigationPage({super.key});
  ...
  Map<String, dynamic> _config = {
    ...
    'items': [
      ...
      },
      {
        'name': '课程',
        'iconPath': 'course',
        'selectedIconPath': 'course_active',
      ...
      },
      {
        ...
        'selectedIconPath': 'subscription_active',
