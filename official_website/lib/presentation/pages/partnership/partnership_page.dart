...
class _PartnershipPageState extends State<PartnershipPage>
  ...
  final List<IndustryCategory> _industries = [
    ...
    IndustryCategory(
      ...
      name: '服务外包',
      icon: '🎯',
      subCategories: ['所有服务', '客服外包', '设计外包', '开发外包', '运营外包'],
    ),
  ];
