...
/// 1. 注册服务商账户（账号+密码）
/// 2. 手机号码注册（手机号+验证码）
class MerchantRegisterDialog extends StatefulWidget {
  const MerchantRegisterDialog({super.key});

  @override
  State<MerchantRegisterDialog> createState() => _MerchantRegisterDialogState();
}

class _MerchantRegisterDialogState extends State<MerchantRegisterDialog> {
  /// 当前选中的注册方式
  int _selectedRegisterMethod = 0; // 0: 服务商账户, 1: 手机号码
...
/// 显示服务商注册弹窗的工具函数
void showMerchantRegisterDialog(BuildContext context) {
  showDialog(
    context: context,
    barrierColor: Colors.black.withValues(alpha: 0.5),
    builder: (context) => const MerchantRegisterDialog(),
  );
}
